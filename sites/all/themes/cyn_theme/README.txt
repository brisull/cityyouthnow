...
cyn theme is a stylized, re-colorable, multi-column theme which uses HTML5
...
cyn theme 7.x-2.x is a sub-theme of Adaptivetheme, you must download and install
...
* Theme settings and layout: cyn theme includes lots of theme settings including
  the ability to change the layout and support for mobile devices. Visit the
  theme settings page admin/appearance/settings/cyn_theme to configure your settings.
...
* Color options: Enable the theme at admin/appearance, and visit
  admin/appearance/settings/cyn_theme to modify the color scheme if desired.

* Menus: The cyn_theme theme does not support the hard coded menu defaults. To setup
...
cyn_theme supports the Superfish module which is a dynamic menu module and enables 
...
http://drupal.org/project/issues/cyn_theme
