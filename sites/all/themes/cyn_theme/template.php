<?php
// cyn theme by Adaptivethemes.com

/**
 * Override or insert variables into the html template.
 */
function cyn_theme_preprocess_html(&$vars) {
  global $theme_key;

  $theme_name = 'cyn_theme';
 ...
 * Override or insert variables into the html template.
 */
function cyn_theme_process_html(&$vars) {
 ...
 */
function cyn_theme_process_page(&$vars) {
  // Hook into color.module
  if (module_exists('color')) {
 ...
 */
function cyn_theme_preprocess_block(&$vars) {
 ...
 */
function cyn_theme_preprocess_field(&$vars) {
