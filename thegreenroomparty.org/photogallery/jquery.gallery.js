$(function() {
    ...
    */
    ...
    $("#scrollRight").unbind("click").bind("click", function() {
        var divWidth = $('#thumbsWrapper').width();
        var lastLi = $('#thumbsContainer').find('img:last-child');
        var ulWidth = lastLi[0].offsetLeft + lastLi.outerWidth();
        var left = $('#thumbsWrapper').scrollLeft() + (divWidth - 200) ;
    ...
    $("#scrollLeft").unbind("click").bind("click", function() {
        var divWidth = $('#thumbsWrapper').width();
        var firstLi = $('#thumbsContainer').find('img:first-child');
        var ulLeft = firstLi[0].offsetLeft;
        var left = $('#thumbsWrapper').scrollLeft() - (divWidth);
        $('#thumbsWrapper').animate({
                scrollLeft : left
                }, 800);
        if ( left < 100 ) {
